...
const Reins = new Vignette(
    ...
    null,
    "Description",
    "Les Courants Océaniques : Différents Types, Causes, Effets Et Importance | Durabl"
);

const Poumons = new Vignette(
